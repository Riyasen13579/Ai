    ...
    try:
        ...
        if 'stop' in query or 'exit' in query:
            ...
            if 21 <= hour or hour < 6:
                farewell = "Good night Ma'am, take care!"
            else:
                farewell = "Have a good day Ma'am!"
            print(farewell)
            speak(farewell)
            exit()

        # If not exit/stop, respond with a random phrase
        ...
        print(f"Couldn't request results from Google; {e}")
